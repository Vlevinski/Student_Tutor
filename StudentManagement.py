...
from StudentRecordClass import Student
import csv


# create the record with student'information for testing purposes 
## fodselsNummer,firstName,lastName,age,email,programmingCourse ="11056027043","John","Smith", 17,"jonnyboy@yahoo.com","python"

# create the instance of StudentRecordsClass
## student = Student(fodselsNummer, firstName, lastName, age, email, programmingCourse)

# call DisplayName() function
## student.DisplayName()

# create demo of DisplayName() function by removing of ## simbols from previous commands
## exit(999)     
...
while dataentry:
    ...
    dtemp.append({"fodselsNummer":iD, "firstName":fN, "lastName":lN, "age": age, "email":email, "programmingCourse": pCourse })
    dataentry  = startEnterInfo(); print (dataentry)
